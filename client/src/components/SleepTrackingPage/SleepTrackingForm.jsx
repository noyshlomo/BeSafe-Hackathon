...
const SleepTrackingForm = ({ userId }) => {
  ...
  return (
    <form className="sleep-tracking-form" onSubmit={handleSubmit}>
      <div className="sleep-tracking-form-group">
      ...
      <button className="sleep-tracking-form-submit" type="submit">
        Send
      </button>
    </form>
  );
